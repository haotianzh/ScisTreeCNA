                ...
                for g1 in range(self.CN_MAX+1):
                    ...
                    for g0_ in range(self.CN_MAX+1):
                        for g1_ in range(self.CN_MAX+1):
                            ...
                            mat[self.index_gt(g0, g1), self.index_gt(g0_, g1_)] = np.log(val) if self.log_transform else val
        return mat
...
if __name__ == "__main__":
    ...
    prob = TransitionProbability(log_transform=True, LAMBDA_C=1000, LAMBDA_S=1, LAMBDA_T=2*100-1, CN_MAX=5, CN_MIN=1)
